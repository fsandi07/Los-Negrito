   ...
   public class UsuariosHelper
    {
        ...
        public void Modificar_usuarios()
        {
            try
            {
                cnGeneral = new Datos();
                ...
                parParameter[7] = new SqlParameter();
                parParameter[7].ParameterName = "@rol";
                parParameter[7].SqlDbType = SqlDbType.VarChar;
                parParameter[7].Size = 50;
                parParameter[7].SqlValue = OBJusuarios.Rol;

                parParameter[8] = new SqlParameter();
                parParameter[8].ParameterName = "@estado";
                parParameter[8].SqlDbType = SqlDbType.VarChar;
                parParameter[8].Size = 50;
                parParameter[8].SqlValue = OBJusuarios.Estado;
