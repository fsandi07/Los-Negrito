                ...
                <div class="card-body table-full-width table-hover">
                    <div class="table-responsive">
                                        ...
                                        <div class="row">                                         
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txt_id_Colaborador" runat="server" class="form-control" OnTextChanged="txt_id_Colaborador_TextChanged" AutoPostBack="True"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">Mes</label><br />
                                                    <asp:DropDownList ID="DptMes" runat="server" class="selectpicker" data-style="select-with-transition" OnSelectedIndexChanged="DptMes_SelectedIndexChanged" AutoPostBack="True">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="Dpquincena" runat="server" class="selectpicker" data-style="select-with-transition" OnSelectedIndexChanged="Dpquincena_SelectedIndexChanged">
                                                         <asp:ListItem Value="Seleccionar">Seleccionar</asp:ListItem>
                        ...
                        <div class="form-group">
                          ...
                          <asp:DropDownList ID="Dptyear" runat="server" class="selectpicker" data-style="select-with-transition" OnSelectedIndexChanged="Dptyear_SelectedIndexChanged">
                                                 <asp:ListItem Value="Seleccionar">Seleccionar</asp:ListItem>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    Periodo.......................:
                    <asp:Label ID="LblQuincena" class="col-sm-2 col-form-label" runat="server" Text=""></asp:Label><br />
                    Banco.........................:
                    <asp:Label ID="LblBanco" class="col-sm-2 col-form-label" runat="server" Text="">  </asp:Label><br />
                    Moneda........................:
                    <asp:Label ID="LblMoneda" class="col-sm-2 col-form-label" runat="server" Text=""></asp:Label><br />
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:Button ID="BtnBorrar" class="btn btn-danger " runat="server" Text="Eliminar" OnClick="BtnBorrar_Click" />
                    </div>
                </div>
            </div>
        </div>
