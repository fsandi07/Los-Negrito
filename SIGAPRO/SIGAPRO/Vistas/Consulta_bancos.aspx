                ...
                <div class="col-md-6 ml-auto mr-auto">
                  <div class="card">
                    <div class="card-body text-center">
                        <code>Agregar nuevo Banco?</code><br />
                       <asp:Button class="btn btn-primary" ID="Btn_redirije" runat="server" alling="Center" Text="Nuevo Banco" OnClick="Btn_redirije_Click" />
                    </div>
                  </div>
                </div>
              </div>
